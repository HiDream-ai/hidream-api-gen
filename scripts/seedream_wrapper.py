#!/usr/bin/env python3
"""
LEGACY adapter for Seedream T2I (Text-to-Image) Skill.

Prefer `scripts.dispatcher` for all new multimodal generation entry.
This wrapper remains only for backward compatibility with older callers.
